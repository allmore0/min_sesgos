...
class MultiSubstitutionCipher:
    def __init__(self, key_seed=42):
        """
        Inicia el cifrado con una semilla para generar tablas de sustitución consistentes.
        """
    ...
    def _generate_maps(self):
        """Genera el multiple random de mapeo para substitucion."""
    ...
    def encrypt(self, text):
        """Aplicando las multiples layers de substitucion."""
    ...
    def decrypt(self, text):
        """Reversando las multiples layers de substitucion."""
        current_text = text
